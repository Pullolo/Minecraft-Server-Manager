...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![greet, get_app_data, folder_exists, save_app_data, fetch_servers, fetch_server_storage_sizes, ping_minecraft_server, open_directory, open_terminal])
